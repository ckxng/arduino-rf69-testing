...
#ifndef HELLO_SENDER_INCLUDE_CONFIG_H_
#define HELLO_SENDER_INCLUDE_CONFIG_H_

#include <Arduino.h>
#include <string>

/// change addresses for each client board, any number :)
const static int MY_ADDRESS = 2;
...
const static int DEST_ADDRESS = 1;

#endif // HELLO_SENDER_INCLUDE_CONFIG_H_
